...
genome:/afs/nd.edu/user28/dpandiar/emaker/agambiae.1k-2k.subset.clean.fa #genome sequence file in fasta format
...
est:/afs/nd.edu/user28/dpandiar/emaker/agambiae.TRANSCRIPTS-AgamP3.6.fa #non-redundant set of assembled ESTs in fasta format (classic EST analysis)
est_reads: /afs/nd.edu/user28/dpandiar/emaker/agambiae.EST-RAW.dec10.fa	 #unassembled nextgen mRNASeq in fasta format (not fully implemented)
...
protein: /afs/nd.edu/user28/dpandiar/emaker/agambiae.PEPTIDES-AgamP3.6.fa #protein sequence file in fasta format
...
predictor: snap,est2genome,protein2genome #prediction methods for annotations (seperate multiple values by ',')
unmask:1 #Also run ab-initio methods on unmasked sequence, 1 = yes, 0 = no
snaphmm: /afs/nd.edu/user28/dpandiar/emaker/stevensi.hmm
gmhmm: #GeneMark HMM model
augustus_species: #pea_aphid#Augustus gene prediction model
...
keep_preds:1 #Add non-overlapping ab-inito gene prediction to final annotation set, 1 = yes, 0 = no
map_forward:0 #try to map names and attributes forward from gff3 annotations, 1 = yes, 0 = no
retry:10 #number of times to retry a contig if there is a failure for some reason
